...
<th class="navWrap navWrap-sel"> 
<a class="nav1" href="<%=basePath%>index.jsp"><span>首页</span></a>        
</th>	
 
 
<th class="navWrap"> 
<a class="nav1" href="<%=basePath%>jd.jsp"><span>客房信息</span></a>        
</th>
<th class="navWrap"> 
<a class="nav1" href="<%=basePath%>s.jsp"><span>客房查询</span></a>        
</th>
<th class="navWrap"> 
<a class="nav1" href="<%=basePath%>xw.jsp"><span>景点信息</span></a>        
</th>
 

<th class="navWrap"> 
<a class="nav1" href="<%=basePath%>member/index.jsp"><span>用户中心</span></a>        
</th> 

<th class="navWrap"> 
<a class="nav1" href="<%=basePath%>login2.jsp"><span>管理登录</span></a>        
</th>

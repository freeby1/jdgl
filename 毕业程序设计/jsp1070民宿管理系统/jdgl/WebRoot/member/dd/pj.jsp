...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">评分：</td>
     <td><select name="pf"> 
     ...
     <tr><input type="hidden" name="method" value="<%=method%>" /><input type="hidden" name="id" value="<%=id%>" /> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">评价：</td>
     <td><input type="text" name="pj" class="span4" required/></td> 
     </tr> 
     <tr>

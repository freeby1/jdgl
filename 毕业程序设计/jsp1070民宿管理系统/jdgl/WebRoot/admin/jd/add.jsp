...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		String id="";String mc="";String fl="";String jg=""; String pic="";String nr="";String jf="";
...
<table class="table table-bordered"> 
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">客房类型：</td>
    ...
    <%}} %>
     ...
     <td><input type="number" name="jg" min="1" class="span2" value="<%=jg %>" required/> 元</td> 
     </tr> 
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">客房图片：</td>
     <td><input type=file name="pic" class="span4" required/>   jpg格式图片</td> 
     </tr>  
     <%} %> 
     <tr>
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">客房面积：</td>
     <td><input type="number" name="jf" min="1" class="span2" value="<%=jf %>" required/></td> 
     </tr>  
     <tr>

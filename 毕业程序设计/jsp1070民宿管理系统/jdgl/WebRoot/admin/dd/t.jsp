...
<form action="<%=basePath %>admin/dd/tinfo.jsp" method="post" name="form1">
<table class="table table-bordered">
	 <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">开始时间：</td>
     <td><input type="date" name="ksj" class="span3" required/></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">截止时间：</td>
     <td><input type="date" name="esj" class="span3" required/></td> 
     </tr> 
     <tr>

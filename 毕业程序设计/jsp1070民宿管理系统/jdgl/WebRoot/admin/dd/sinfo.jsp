...
<div class="title_right"><strong>客房预定管理</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>客房名称</strong></td> 
         <td nowrap="nowrap"><strong>类型</strong></td>
         <td nowrap="nowrap"><strong>价格</strong></td>
         <td nowrap="nowrap"><strong>数量</strong></td>   
         <td nowrap="nowrap"><strong>总价</strong></td>   
         <td nowrap="nowrap"><strong>会员</strong></td>   
         <td nowrap="nowrap"><strong>会员价</strong></td>  
         <td nowrap="nowrap"><strong>积分</strong></td>   
         <td nowrap="nowrap"><strong>用户</strong></td>  
         <td nowrap="nowrap"><strong>预订日期</strong></td>   
         <td nowrap="nowrap"><strong>审核</strong></td>   
         <td nowrap="nowrap"><strong>通知</strong></td>   
         <td nowrap="nowrap"><strong>入住</strong></td>   
         <td nowrap="nowrap"><strong>结账</strong></td> 
         <td nowrap="nowrap"><strong>评分</strong></td>   
         <td nowrap="nowrap"><strong>评价</strong></td>    
         <td width="80" nowrap="nowrap"><strong>操作</strong></td>
       </tr>
<%	String word=Common.toChineseAndTrim(request.getParameter("word")); 
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from dd where ddh like '%"+word+"%' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from dd where ddh like '%"+word+"%' order by id desc",19);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap"><%=pagelist2.get(18).toString() %></td>                   
         <td nowrap="nowrap">  
         <%if(pagelist2.get(13).toString().equals("已通过")){ %>
         <a href="<%=basePath%>ComServlet?method=rz&id=<%=pagelist2.get(0).toString()%>">入住</a>
         <a href="<%=basePath%>ComServlet?method=jz&id=<%=pagelist2.get(0).toString()%>">结账</a>
         <%}else{ %>
...
<% }} %>
       <tr align="center">
         <td nowrap="nowrap" colspan="22"><input type="hidden" name="word" value="<%=word%>" />

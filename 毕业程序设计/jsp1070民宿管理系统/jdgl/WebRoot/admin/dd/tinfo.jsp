...
<%	String ksj=Common.toChineseAndTrim(request.getParameter("ksj")); String esj=Common.toChineseAndTrim(request.getParameter("esj")); 
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from dd where dd>='"+ksj+"' and dd<='"+esj+"' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from dd where dd>='"+ksj+"' and dd<='"+esj+"' order by id desc",19);
...
<% }} %>
       <tr align="center">
         <td nowrap="nowrap" colspan="22"><input type="hidden" name="ksj" value="<%=ksj%>" /><input type="hidden" name="esj" value="<%=esj%>" />

...
<div class="title_right"><strong>民宿管理信息系统</strong></div>  
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">订单审核：</td>
     <td><select name=sh> 
     ...
     <tr><input type="hidden" name="method" value="<%=method%>" /><input type="hidden" name="id" value="<%=id%>" /> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">发送短信：</td>

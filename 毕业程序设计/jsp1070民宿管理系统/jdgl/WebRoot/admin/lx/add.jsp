...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";String lx="";String zk=""; 
		if(method.equals("uplx")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from lx where id='"+id+"'",3);
			lx=jlist.get(1).toString();
			zk=jlist.get(2).toString();   
		}	  
%>
<body>
<div class="right_cont">
<div class="title_right"><strong>会员类型管理</strong></div>  
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">类型：</td>
     <td><input type="text" name="lx" class="span4" value="<%=lx %>" required/></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">折扣：</td>
     <td><input type="number" min="1" max="100" name="zk" class="span4" value="<%=zk %>" required/> 例：9折请输入90</td> 
     </tr> 
     <tr>
